...
if [ ! -f $file1 ]; then
    echo -e "\033[0;31m $file1 file is not found ( please rename your firmwere folder to flash-rom then copy to under download folder in internal storage ) \033[0m";
    exit 1;    
fi
